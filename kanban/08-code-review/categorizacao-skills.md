...
- **Onde:** `~/.claude/skills/{method,chat,commit,fast,todo,solve,ask,chat-out,claude-modes}` apontavam para `skills/<slug>` (flat); `make-dev` apontava para o repo `labzz-skillzz`.
