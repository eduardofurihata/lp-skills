...
```
mcp__atlassian__jira_get → /rest/api/3/issue/AV-36
```
Verificar campo `assignee`.

### 4.2 — Atribuir a si mesmo (se necessário)
```
mcp__atlassian__jira_put → /rest/api/3/issue/AV-36/assignee
...
```
mcp__atlassian__jira_get → /rest/api/3/issue/AV-36/transitions
```
