...
- **O design system do app.** Tokens, componentes, tipografia, ícones e escalas são os do projeto, lidos do projeto. Nada inventado fora deles; o que o DS não tem, sai da composição do que ele tem.
