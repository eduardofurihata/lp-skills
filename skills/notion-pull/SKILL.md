...
Quando o usuário digitar `/notion-pull <slug>` (ex: `/notion-pull insta`), execute este fluxo:
...
5. **Erro de conexão:** se `fetch` falha (ECONNREFUSED ou similar), responda:
   > "pm-forge não está rodando. Execute `pm-forge` ou `make dev` no diretório do app primeiro (`/home/furihata/GitHub/labzz-pm-forge` ou onde o app está)."
...
[pm-forge] Baixando "Reels — Product Doc" (1/3)
[pm-forge] Baixando "Stories" (2/3)
[pm-forge] Baixando "AI Features" (3/3)
[pm-forge] ✓ Concluído. ~/pm-forge/insta/
```
