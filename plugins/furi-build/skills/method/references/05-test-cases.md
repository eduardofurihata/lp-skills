...
`docs/05-test-cases/<tópico>.md` — nome por domínio; doc que já cobre o domínio se **atualiza**, não se duplica (`inventario-docs.md`). Todo UC do Step 3 e todo detalhe do Spec aparecem em alguma linha `Cobre`.
...
### Analisar a complexidade (dos Steps 3-4)
