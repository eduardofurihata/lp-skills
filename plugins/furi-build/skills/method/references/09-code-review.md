...
**Revisar até 100% limpo, princípio a princípio e por nome — e nada do que aparecer fica só na cabeça:** corrigido agora.

**Chame e use:** `/solve` via Skill tool

## 9a — Revisão em loop

Repita até zero issues — nunca "bom o suficiente":
...
6. Problema ou achado → corrige agora e volta ao 1.
...
Relatório **brutalmente honesto**. **Não cria nem aprova PR** — só revisa, corrige e atualiza o existente. Veredicto ❌ → volta ao 8b e roda o Step 9 inteiro.
