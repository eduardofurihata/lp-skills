...
`docs/05-design/design-system.md` — **único e cumulativo**, vive entre features: cada uma lê, usa e faz crescer. Projeto sem DS? A primeira feature o **funda** com o mínimo que os UCs exigem. O que este step promove entra nele **agora** — o 8b só usa. Padrão do DS abaixo do nível no perímetro desta feature: **eleva** aqui, ou vira item do ledger — não se copia adiante.
