...
> **Este arquivo é a fonte única de design.** Nenhum outro arquivo redefine os princípios de design — todos apontam para cá (DRY aplicado ao próprio protocolo). O que cada step tem é a **lente**: o que o princípio significa *naquele* step. Irmão de `principles/SKILL.md`, mesma régua.
