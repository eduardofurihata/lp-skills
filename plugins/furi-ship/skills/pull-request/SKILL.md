...
5. **Espelhar — em cada card dos commits.** Mover o card para o status da etapa (`setup.md § Processo`) e comentar o `## O que foi feito` com o link da PR; PR atualizada → só nos cards que ainda não têm o comentário. Sem Jira, no-op.
