...
- [ ] Mover cada card dos commits para o status da etapa e comentar o `## O que foi feito` com o link da PR
- [ ] Retornar PR (URL, base) ou "publicado sem PR", branch e cards; próximo: `/homolog`
