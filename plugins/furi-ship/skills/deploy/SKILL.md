...
# deploy — publicar, configurar, validar, devolver
...
4. **Devolver.** `{publicado, configurado, validado}` a quem chamou; com passo aberto, **o que ficou, por quê e o que destrava** — meio-caminho relatado como sucesso é o defeito que este pacote conserta.
