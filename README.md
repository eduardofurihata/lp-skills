...
/plugin install furi-build@lp-skills       # o método (/principles, /ui, /solve, /method, /todo, /proto)
...
/plugin install furi-toolbox@lp-skills     # ferramentas avulsas (/brain, /blind, /ask, /chat, /save, /sync, /make-dev, /proof, /video-teams…)
```
